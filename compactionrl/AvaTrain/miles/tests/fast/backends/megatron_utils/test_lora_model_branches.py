...
class TestSaveLoRaBranch:
    ...
    def test_non_lora_model_calls_regular_save(
        ...
        save(42, model, MagicMock(), MagicMock(), checkpointing_context=checkpointing_context)

        mock_save_ckpt.assert_called_once()
        assert mock_save_ckpt.call_args.kwargs["checkpointing_context"] is checkpointing_context
